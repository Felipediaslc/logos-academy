...
bg-clip-text bg-gradient-to-r from-white to-orange-500 font-medium 
font-mono">
...
<p className="mt-6 max-w-xs text-center text-sm text-gray-200 
lg:max-w-[43.375rem] lg:text-base">
A Logos Academy, 
é uma escola de programação que já transformou 
a vida de mais de 55 mil alunos e alunas através
do ensino de tecnologia e programação.
Junto a Digital House, reunimos a maior comunidade
de devs da America Latina e temos o objetivo de impulsionar
pessoas para o seu próximo nível, independente do seu momento
de carreira.</p>
</div>
</div>
</section>
...
className="rounded-[10px] max-lg:w-full color: transparent;"
...
Especialista em JavaScript, com foco em React e Node.js.
