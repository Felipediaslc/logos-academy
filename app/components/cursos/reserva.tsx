/*
<div>
      <ul className="flex max-w-full gap-4 tracking-[1.4px] max-sm:overflow-y-hidden max-sm:overflow-x-scroll md:flex-wrap">
        <li>
            ...
            <div className="h-12 w-12">
              ...
              loading="lazy" width="48"
               height="48" decoding="async"
                data-nimg="1" src="https://storage.googleapis.com/star-lab/novo-site/formacoes/techs-icon/javascript-icon.svg"
                className="color: transparent;"/>
                  ...
                  <li>
                    <button data-state="closed">
                      <div className="h-12 w-12">
                        <Image alt="HTML" loading="lazy"
                         width="48" height="48" decoding="async"
       data-nimg="1" src="https://storage.googleapis.com/star-lab/novo-site/formacoes/techs-icon/html-icon.svg"
       className="color: transparent;"/>
        </div>
        </button>
        </li>
        <li>
          <button data-state="closed">
            <div className="h-12 w-12">
              <Image alt="CSS" loading="lazy" width="48"
               height="48" decoding="async" data-nimg="1"
                src="https://storage.googleapis.com/star-lab/novo-site/formacoes/techs-icon/css-icon.svg"
                className="color: transparent;"/>
                  </div>
                  </button>
                  </li>
                  ...
                  <li>
                    <button data-state="closed">
                  <div className="h-12 w-12">
                    <Image alt="ReactJs" loading="lazy" width="48" height="48" decoding="async"
                     data-nimg="1" src="https://storage.googleapis.com/star-lab/novo-site/formacoes/techs-icon/react-icon.svg"
                     className="color: transparent;"/>
                        </div>
                        </button>
                        </li>
  ...
  <button data-state="closed">
    <div className="h-12 w-12">
      <Image alt="Node.js" loading="lazy" width="48"
       height="48" decoding="async" data-nimg="1"
        src="https://storage.googleapis.com/star-lab/novo-site/formacoes/techs-icon/nodejs-icon.svg"
        className="color: transparent;"/>
          </div>
          </button>
          </li>
...
<ul className="flex max-w-full gap-4 tracking-[1.4px] max-sm:overflow-y-hidden max-sm:overflow-x-scroll md:flex-wrap">
      <li>
        <button data-state="closed">
          <div className="h-12 w-12">
            <Image alt="JavaScript" loading="lazy" width="48" height="48" decoding="async"
             data-nImage="1" src={Html5} 
             className="color: transparent;"/>
              </div>
              </button>
              </li>
              <li>
                <button data-state="closed">
              <div className="h-12 w-12">
                <Image alt="HTML" loading="lazy" width="48" height="48"
               decoding="async" data-nImage="1"
                src={Css}
                 className="color: transparent;"/>
                  </div>
                  </button>
                  ...
                  <li>
                    <button data-state="closed">
                  <div className="h-12 w-12">
                    <Image alt="CSS" loading="lazy" width="48" height="48"
                   decoding="async" data-nImage="1"
                   src={Css}
                     className="color: transparent;"/>
                      </div>
                      ...
                      <div className="h-12 w-12">
                        <Image alt="ReactJs" loading="lazy" width="48" height="48" decoding="async"
                       data-nImage="1" src={Git}
                        className="color: transparent;"/>
                        </div>
                        </button>
                        </li>
                        <li>
                          <button data-state="closed"><div className="h-12 w-12">
                          <Image alt="Node.js" loading="lazy" width="48"
                           height="48" decoding="async" data-nImage="1"
                            src={Javascript}
